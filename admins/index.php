...
<head>
    <head>
        ...
        <link type="text/css" href="Content/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
        <link type="text/css" href="Content/css/theme.css" rel="stylesheet">
                        ...
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="message.html"><i class="menu-icon icon-inbox"></i>Inbox <b class="label green pull-right">
                                    11</b> </a></li>
                                <li><a href="./index.php?action=hanghoa&act=hanghoa"><i class="menu-icon icon-tasks"></i>Sản Phẩm <b class="label orange pull-right">
                                    19</b> </a></li>
                            </ul>
                            <!--/.widget-nav-->
