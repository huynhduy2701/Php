...
<form action="index.php?action=dangnhap&act=dangnhap_action" class="my-5" method="post">
        <section class="vh-100 gradient-custom">
          <div class="container py-5 h-100 ">
            <div class="row d-flex justify-content-center align-items-center h-100">
              <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card text-black" style="border-radius: 1rem;">
                  <div class="card-body p-5 text-center rounded-3 shadow-lg  bg-body-tertiar">
                    ...
                    <div class="mb-md-5 mt-md-4 pb-5">
                      ...
                      <div class="form-outline form-white mb-4">
                        ...
                        <input type="text" id="typeEmailX" name="txtuser" class="form-control form-control-lg" />
                      </div>
                    ...
                    <div>
                      <p class="mb-0">Don't have an account? <a href="index.php?action=dangky" class="text-black-50 fw-bold">Sign Up</a>
                      </p>
                    </div>
