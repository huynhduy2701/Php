            ...
            <!-- <form action="index.php?action=forget&act=forget_action" method="post">
              <div class="row gy-3 gy-md-4 overflow-hidden">
                <div class="col-12">
                  ...
                  <input type="email" class="form-control" name="email" id="email" placeholder="Nhập Email tài khoản" required>
                </div>
                <div class="col-12">
                  <div class="d-grid">
            ...
            <div class="row">
              <div class="col-12 ">
                ...
                <div class="d-flex gap-2 gap-md-4  flex-column flex-md-row justify-content-md-end">
                  <a href="index.php?action=dangnhap" class="link-secondary text-decoration-none ">Login</a>
                  <a href="index.php?action=dangky" class="link-secondary text-decoration-none ">Register</a>
                </div>
              </div>
            </div>
          </div>
